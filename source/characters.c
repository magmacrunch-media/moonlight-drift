...
/* hitbox_* mirror the `hitbox` block in the source game's js/characters/<id>.js.
   ...
   Sprite paths are relative to the app's SD directory; the engine resolves them
   via magnolia_asset_path(). */
static const CharacterData all_characters[] = {
    ...
    },
    {
        ...
        "sprites/gangsta-beaver-idle.png",
        "sprites/gangsta-beaver-thrust.png",
        40, 35, 0, 0,
        15, 23,
        -0.6f, 0.4f, 10.0f
    }
